...
myApp.services = {
  ...
  tasks: {
    ...
    create: function(data) {
      ...
      var taskItem = ons.createElement(
       '<ons-list-item tappable style="border-bottom: 1px solid #D8D8D8" category="' + myApp.services.categories.parseId(data.category)+ '">' +
          '<label class="left" style=\"padding-left: 5px\">' +
           '<ons-checkbox></ons-checkbox>' +
          '</label>' +
		  '<div class=\"left\"> <img class=\"list-item__thumbnail\" src=\"lib/onsen/img/wolle.jpg\" > </div>' +
          '<div class="center">' +
            data.title +
          '</div>' +
          '<div class="right">' +
      ...
      taskItem.data.onCheckboxChange = function(event) {
        myApp.services.animators.swipe(taskItem, function() {
         ...
         // document.querySelector(listId).appendChild(data.title);
        });
  ...
  categories: {
    ...
    create: function(categoryLabel) {
      ...
      var categoryItem = ons.createElement(
        '<ons-list-item tappable onclick="playww4()" category-id="' + categoryId + '">' +
          '<div class="left">' +
  ...
  fixtures: [

    {
      title: 'Einkaufen Edi',
      category: 'Einkaufen',
      description: 'Butter, Mehl, Milch, Salz, Salat, Kuchen',
      urgent: false
    },
    {
